...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#0f172a] relative overflow-hidden font-['Inter',sans-serif]">
      ...
      {/* Navigation */}
      <nav className="sticky top-0 z-50 glass-panel-strong px-4 sm:px-8 py-3.5 flex items-center justify-between max-w-7xl mx-auto my-3 rounded-2xl">
      ...
      {/* Hero Section */}
      <section className="max-w-6xl mx-auto px-4 sm:px-8 pt-16 sm:pt-28 pb-16 text-center relative z-10">
        <div className="inline-flex items-center space-x-2 bg-indigo-50/80 border border-indigo-100/50 backdrop-blur-md rounded-full px-4.5 py-1.5 mb-8 animate-fade-in shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in">
          <Link
            to="/signup"
            className="group flex items-center space-x-2 bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 hover:opacity-95 text-white font-bold text-sm px-8 py-4 rounded-2xl shadow-xl shadow-indigo-500/20 transition-all active:scale-[0.98]"
          >
          ...
          <Link
            to="/dashboard"
            className="flex items-center space-x-2 text-slate-600 hover:text-slate-800 font-bold text-sm px-7 py-4 rounded-2xl border border-slate-200/80 bg-white/70 backdrop-blur-md hover:bg-white hover:shadow-md transition-all active:scale-[0.98]"
          >
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-8 pb-24 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-4 flex flex-col justify-center space-y-3">
            ...
            <button
              ...
              className="mt-4 flex items-center justify-center space-x-2 py-3.5 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-40 disabled:cursor-not-allowed text-white text-xs font-bold rounded-2xl transition-all shadow-md shadow-indigo-500/10 active:scale-[0.98]"
            >
          ...
          <div className="lg:col-span-8 glass-panel-strong rounded-3xl overflow-hidden flex flex-col shadow-xl border border-slate-200/80 min-h-[380px]">
            ...
            <div className="bg-slate-50/80 px-5 py-3.5 border-b border-slate-100 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-1.5 text-[10px] font-bold text-slate-400 bg-white border border-slate-200 rounded-lg px-2.5 py-1">
            ...
            {/* Mock Chat View */}
            <div className="flex-1 p-5 space-y-4 overflow-y-auto bg-white/40 flex flex-col justify-end">
              ...
              {simulationState === 'matching' && (
                <div className="flex items-center space-x-2 text-indigo-500 font-bold text-[11px] py-2 animate-pulse">
              ...
              {(simulationState === 'streaming' || simulationState === 'complete') && (
                <div className="space-y-3 animate-fade-in">
                  ...
                  {simulationState === 'complete' && (
                    <div className="pl-9 space-y-1.5 animate-fade-in">
      ...
      {/* Tech Stack */}
      <section className="max-w-4xl mx-auto px-4 sm:px-8 pb-24 text-center relative z-10">
        <div className="mb-10">
      ...
      <footer className="border-t border-slate-200/50 py-10 px-4 text-center bg-white/40 backdrop-blur-md relative z-10">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            ...
            className="flex items-center space-x-1.5 text-xs text-slate-500 hover:text-indigo-600 transition-colors font-bold"
          >
